 ...
 *
 */
class Production_planning_detail extends Abstract_model
{

    public $table = "planning_part";
    public $pkey = "planning_part_id";
    public $alias = "a";

    public $fields = array(
        'production_planning_id' => array('pkey' => true, 'type' => 'int', 'nullable' => true, 'unique' => true, 'display' => 'production_planning_id'),
        'po_number' => array('nullable' => false, 'type' => 'str', 'unique' => true, 'display' => 'po_number'),
        'client_name' => array('nullable' => false, 'type' => 'str', 'unique' => true, 'display' => 'client_name'),
        'due_date_start' => array('nullable' => false, 'type' => 'date', 'unique' => false, 'display' => 'due_date_start'),
        'due_date_end' => array('nullable' => false, 'type' => 'date', 'unique' => false, 'display' => 'due_date_end'),
        'product_planning_id' => array('nullable' => false, 'type' => 'int', 'unique' => false, 'display' => 'product_planning_id'),
        'pp_qty_init' => array('nullable' => false, 'type' => 'float', 'unique' => false, 'display' => 'pp_qty_init'),
        'pp_qty' => array('nullable' => false, 'type' => 'float', 'unique' => false, 'display' => 'pp_qty'),
        'send_type' => array('nullable' => false, 'type' => 'str', 'unique' => false, 'display' => 'send_type')
    ...
    public $fromClause = "planning_part a";
