...
<script>
    ...
    jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
            url: '<?php echo WS_JQGRID."agripro.repacking_controller/crud"; ?>',
            datatype: "json",
            mtype: "POST",
            colModel: [
            ...
            onSelectRow: function (rowid) {
                ...
                if (rowid != null) {
                    grid_detail.jqGrid('setGridParam', {
                        url: '<?php echo WS_JQGRID."agripro.repacking_detail_controller/crud"; ?>',
            ...
            editurl: '<?php echo WS_JQGRID."agripro.repacking_controller/crud"; ?>',
            caption: "Repacking"
        ...
        jQuery("#grid-table-detail").jqGrid({
            ...
            colModel: [
                ...
                {label: 'Batch Number',name: 'rd_batch_number', width: 120, align: "left",editable: true,
                    editoptions: {
                        size: 15,
                        maxlength:32
                    },
                ...
                {label: 'Berat(Kg)', name: 'rd_berat', width: 120, align: "right", editable: true, formatter:'number',
                    edittype: 'text',
                    editrules: {edithidden: true, required: true},
                    formatoptions: { decimalSeparator: ".", thousandsSeparator: " "}
                },
