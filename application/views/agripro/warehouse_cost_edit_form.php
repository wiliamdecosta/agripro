                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="parameter_cost_code" id="parameter_cost_code" readonly="" class="form-control" placeholder="Choose Parameter">
...
<script>
    function insertDataRow() {
        ...
        tdCostCode.innerHTML = '<input type="hidden" name="whcost_det_id[]"><input type="hidden" name="parameter_cost_id[]" value="'+ parameter_cost_id +'">'+ parameter_cost_code;
