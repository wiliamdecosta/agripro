...
<div class="row">
    <div class="col-md-12">
        <button class="btn blue-madison" id="add-warehouse-cost"><i class="fa fa-money bigger-120"></i> Add Cost</button>
    </div>
</div>
<div class="space-4"></div>
<div class="row">
...
<script>
    function editCost(rowId) {
        ...
        loadContentWithParams('agripro.warehouse_cost_edit_form', {
            whcost_id : rowData.whcost_id,
            wh_name : rowData.wh_name,
            whcost_start_date : rowData.whcost_start_date,
            whcost_end_date : rowData.whcost_end_date,
            whcost_description : rowData.whcost_description
        });
    }
...
<script>
    ...
    jQuery(function($) {
        $('#add-warehouse-cost').on('click',function(e) {
            loadContentWithParams('agripro.warehouse_cost_add_form',{});
        });
    });
    ...
    jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
            url: '<?php echo WS_JQGRID."agripro.warehouse_cost_controller/crud"; ?>',
            datatype: "json",
            mtype: "POST",
            colModel: [
                ...
                {label: 'Edit Cost',name: '',width: 120, align: "center",editable: false,
                    formatter:function(cellvalue, options, rowObject) {
                        return '<a class="btn green-meadow btn-xs" href="#" onclick="editCost('+rowObject['whcost_id']+')"><i class="fa fa-pencil"></i>Edit</a>';
                    }
                }
            ],
            height: '100%',
            ...
            onSelectRow: function (rowid) {
                ...
                var celValue = $('#grid-table').jqGrid('getCell', rowid, 'whcost_id');
                var celCode = $('#grid-table').jqGrid('getCell', rowid, 'wh_name');

                var grid_detail = jQuery("#grid-table-detail");
                if (rowid != null) {
                    grid_detail.jqGrid('setGridParam', {
                        url: '<?php echo WS_JQGRID."agripro.warehouse_cost_detail_controller/crud"; ?>',
                        postData: {whcost_id: rowid}
                    });
                    var strCaption = 'Cost Details :: ' + celCode;
            ...
            editurl: '<?php echo WS_JQGRID."agripro.warehouse_cost_controller/crud"; ?>',
        ...
        jQuery("#grid-table-detail").jqGrid({
            ...
            //memanggil controller jqgrid yang ada di controller crud
            editurl: '<?php echo WS_JQGRID."agripro.warehouse_cost_detail_controller/crud"; ?>',
            caption: "Cost Detail"
