                ...
                <form method="post" action="" class="form-horizontal" id="form-packing">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <input type="text" name="packing_tgl" id="packing_tgl" class="form-control required">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input type="text" name="packing_batch_number" readonly="" class="form-control" placeholder="Batch Generated By System">
                            </div>
                            <label class="col-md-2 control-label" for="packing_serial">Serial Number</label>
                            <div class="col-md-3">
                                <input type="text" name="packing_serial" readonly="" class="form-control" placeholder="Serial Generated By System">
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-btn">
                                                <button class="btn btn-success" type="button" onclick="showLovSortir('source_sortir_id','source_product_code','source_product_weight')">
                                                    <span class="fa fa-search icon-on-right bigger-110"></span>
                                                </button>
                                            </span>
                                        </div>
