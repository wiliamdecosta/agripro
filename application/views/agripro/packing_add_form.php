            ...
            <div class="portlet-body form">
                ...
                <form method="post" action="" class="form-horizontal" id="form-packing">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="packing_batch_number">Serial Number</label>
                            <div class="col-md-3">
                                <input type="text" name="packing_batch_number" readonly="" class="form-control" placeholder="Serial Generated By System">
                            </div>
                            <label class="col-md-2 control-label" for="packing_serial">Batch Number</label>
                            <div class="col-md-3">
                                <input type="text" name="packing_serial" readonly="" class="form-control" placeholder="Batch Generated By System">
                            </div>
                        </div>
