...
<script>
    function viewPacking(rowId) {
        ...
        loadContentWithParams('bizhub.packing_edit_form', {
...
<script>
    ...
    jQuery(function($) {
        $('#add-production').on('click',function(e) {
            loadContentWithParams('bizhub.production_add_form',{});
        });
    });
    ...
    jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
            ...
            colModel: [
                {label: 'ID', name: 'production_bizhub_id', key: true, width: 5, sorttype: 'number', editable: true, hidden: true},
                ...
                {label: 'Weight(Kg)', name: 'production_bizhub_qty', width: 80, align: "right", editable: false}
            ],
            height: '100%',
            autowidth: true,
            viewrecords: true,
        ...
        jQuery("#grid-table-detail").jqGrid({
            ...
            //memanggil controller jqgrid yang ada di controller crud
            editurl: '<?php echo WS_JQGRID."agripro.production_detail_bizhub_controller/crud"; ?>',
