<div id="modal_lov_packing" class="modal fade" tabindex="-1" style="overflow-y: scroll;">
    <div class="modal-dialog" style="width:700px;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div>
                  <button type="button" class="btn btn-sm btn-success" id="modal_lov_packing_btn_blank">
                    <span class="fa fa-pencil-square-o" aria-hidden="true"></span> BLANK
                  </button>
                </div>
                <table id="modal_lov_packing_grid_selection" class="table table-striped table-bordered table-hover">
                <thead>
                  <tr>
                     <th data-column-id="packing_id" data-sortable="false" data-visible="false">ID Packing</th>
                     <th data-header-align="center" data-align="center" data-formatter="opt-edit" data-sortable="false" data-width="100">Options</th>
                     <th data-column-id="packing_batch_number" data-width="270">Serial Number</th>
...
<script>
    ...
    jQuery(function($) {
        $("#modal_lov_packing_btn_blank").on('click', function() {
    ...
    function modal_lov_packing_set_value(the_id_val, the_code_val, product_code) {
         ...
         $("#"+ $("#modal_lov_packing_code_val").val()).change();
    }

    function modal_lov_packing_prepare_table() {
        $("#modal_lov_packing_grid_selection").bootgrid({
             ...
             url: '<?php echo WS_BOOTGRID."agripro.packing_controller/readLov"; ?>',
             selection: true,
             sorting:true
        });
