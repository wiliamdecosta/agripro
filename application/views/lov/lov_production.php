    ...
    <div class="modal-dialog" style="width:1000px;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <thead>
                  <tr>
                     <th data-column-id="production_id" data-sortable="false" data-visible="false">ID Produk</th>
                     <th data-header-align="center" data-align="center" data-formatter="opt-edit" data-sortable="false" data-width="100">Options</th>
                     <th data-column-id="production_code" data-width="300">Production Code</th>
        ...
        $("#modal_lov_production_grid_selection").bootgrid({
             formatters: {
                "opt-edit" : function(col, row) {
                    return '<a href="javascript:;" title="Set Value" onclick="modal_lov_production_set_value(\''+ row.production_id +'\', \''+ row.production_code +'\', \''+ row.product_id +'\', \''+ row.product_code +'\', \''+ row.production_qty +'\')" class="blue"><i class="fa fa-pencil-square-o bigger-130"></i></a>';
                }
             },
             rowCount:[5,10],
             ajax: true,
             ...
             url: '<?php echo WS_BOOTGRID."agripro.production_controller/readLov_sortir"; ?>',
             selection: true,
             sorting:true
        });
