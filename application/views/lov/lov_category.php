        ...
        <div class="modal-content">
            ...
            <div class="modal-header no-padding">
                <div class="table-header">
                    <span class="form-add-edit-title"> Category</span>
                </div>
            </div>
            <input type="hidden" id="modal_lov_category_id_val" value="" />
            <input type="hidden" id="modal_lov_category_name_val" value="" />
            ...
            <div class="modal-body">
                ...
                <thead>
                  <tr>
                     <th data-column-id="category_id" data-sortable="false" data-visible="false">Category ID</th>
                     <th data-header-align="center" data-align="center" data-formatter="opt-edit" data-sortable="false" data-width="100">Options</th>
                     <th data-column-id="category_name">Catgeory Name</th>
                  </tr>
                </thead>
                </table>
            </div>
...
<script>
    ...
    jQuery(function($) {
        $("#modal_lov_category_btn_blank").on('click', function() {
            ...
            $("#"+ $("#modal_lov_category_name_val").val()).val("");
        ...
        $("#modal_lov_category_grid_selection").bootgrid({
             formatters: {
                "opt-edit" : function(col, row) {
                    return '<a href="javascript:;" title="Set Value" onclick="modal_lov_category_set_value(\''+ row.category_id +'\', \''+ row.category_name +'\')" class="blue"><i class="fa fa-pencil-square-o bigger-130"></i></a>';
                }
             },
             rowCount:[5,10],
             ajax: true,
             ...
             url: '<?php echo WS_BOOTGRID."agripro.category_controller/readLov"; ?>',
             selection: true,
             sorting:true
        });
