        ...
        try {
            ...
            foreach($items as $item) {
                $output .= '
                    <tr>
                        <td>'.$no++.'</td>
                        <td><input type="hidden" name="whcost_det_id[]" value="'.$item['whcost_det_id'].'"> <input type="hidden" name="parameter_cost_id[]" value="'.$item['parameter_cost_id'].'">'.$item['parameter_cost_code'].'</td>
